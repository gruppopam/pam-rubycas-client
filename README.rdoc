...
This is a fork of the {RubyCAS-Client library}[http://github.com/rubycas/rubycas-client].
All rails applications that include this gem will use a common user session.
